...
function Candidate() {
  ...
  return (
    <div className="mt-5">
      <h2 className="mb-2 text-3xl font-semibold tracking-tight">Кандидат</h2>
      <div>
        ...
        <div className="mb-2 flex">
          ...
          <a href={`mailto: ${data.candidate.email}`} className="block hover:text-blue-500 hover:underline">
